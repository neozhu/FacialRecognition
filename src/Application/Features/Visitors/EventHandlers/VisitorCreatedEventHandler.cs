...
public class VisitorCreatedEventHandler : INotificationHandler<VisitorCreatedEvent>
{
        ...
        public Task Handle(VisitorCreatedEvent notification, CancellationToken cancellationToken)
        {
